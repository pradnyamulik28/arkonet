...
function ClientPassCheck() {
  ...
  const sendOTP = async () => {
    if (
      ...
      try {
        const response = await fetch(`${url_}/client/send-otp?pan=${clientpan}`, requestOptions);
    ...
    <div className={`${style.outercontainer}`}>
      ...
      <div className={`${style.maincontainer}`}>
        ...
        <div className={`${style.copyright}`}>
          ...
          <a href="https://www.arkonetglobal.com/" className={style.ClientPassImg}><img src={arkonet} alt="" id={`${style.arkonet}`} /></a>
